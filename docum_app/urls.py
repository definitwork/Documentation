...
from .views import CategoryContentAPIView, DocCategoryAPIView, BookAPIView, UserPaidContentAPIView, \
    OneCategoryContentAPIView, OneBookAPIView, SubCategoriesInDocCategoryAPIView, SubCategoryAPIView, \
    CategoryContentsInSubCategoryAPIView

urlpatterns = [
    path('doc_category/', DocCategoryAPIView.as_view(), name='doc_category'),
    path('doc_category/<slug:doc_category_slug>/', SubCategoriesInDocCategoryAPIView.as_view()),
    path('sub_category/', SubCategoryAPIView.as_view(), name='sub_category'),
    path('sub_category/<slug:sub_category_slug>/', CategoryContentsInSubCategoryAPIView.as_view()),

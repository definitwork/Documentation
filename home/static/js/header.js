  ...
  return (
    `
      <div class='popup__send'>
        <p>
            На ваш адрес электронной почты было отправлено письмо со сылкой на страницу восстановления пароля.
        </p>
        <p>Пожалуйста, проверьте свою электронную почту и нажмите на ссылку, чтобы продолжить.
